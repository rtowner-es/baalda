-- Context by Keystone · Better Auth core + organization plugin schema
-- Generated with: npx @better-auth/cli generate (better-auth 1.6.23).
-- Columns are camelCase and quoted verbatim by the Kysely pg adapter — do not
-- rename them or Better Auth's queries will miss. Regenerate rather than hand-edit.
